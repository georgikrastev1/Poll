...
def onboard_moderator(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Moderator Created!')
            return redirect('create-moderator')
    else:
        form = UserRegisterForm(initial={'password1': 'Test1234!', 'password2': 'Test1234!' })
    return render(request, 'users/create-moderator.html', {'form': form})
